---
title: pinyin
subtitle: "How to use the R package pinyin"
...
Since this package deals with Chinese characters, it is presumed that the users speak Chinese more or less. Therefore I wrote the instruction in Chinese. In case that some uses do not speak Chinese and want to use this package as well, please feel free to contact me via email, although the R codes in this document are self-explanary. 
...
汉字里有很多多音字，转换时请注意。例如，转换`春眠不觉晓`的结果会让人愣一下，再转换`处处闻啼鸟`……
